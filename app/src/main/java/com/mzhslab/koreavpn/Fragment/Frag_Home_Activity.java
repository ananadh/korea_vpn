    ...
    private void initView(View view) {
        ...
        getAvailableActivity(activity -> {
            if (activity != null) {
                ...
                ivConnectionStatusCr.setVisibility(View.GONE);
            ...
            if (activity != null) {
                if (getBestServer_after_calculation(sharedpreferences) != null) {
                    ...
                    if (level == ConnectionStatus.LEVEL_CONNECTED) {
                        ...
                        btnConnect.setBackgroundResource(R.drawable.connected);
                        ...
                        btnConnect.setBackgroundResource(R.drawable.connecting);
